...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0006_remove_trader_inn_document_address_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(default=uuid.UUID('6bfc8e98-3656-4094-bf24-7a9c455089f0'), max_length=150, unique=True)),
